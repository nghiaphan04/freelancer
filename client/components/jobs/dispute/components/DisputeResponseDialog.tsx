...
import { Dispute, DISPUTE_STATUS_CONFIG } from "@/lib/api";
import { formatDateTime } from "@/lib/format";
import { useDisputeResponse } from "@/hooks/useDisputeResponse";
import { EvidenceCard, formatFileSize, renderEvidenceCard } from "./EvidenceCard";
...
export function DisputeResponseDialog({
  ...
  const {
    ...
    canRespond,
    handleSubmit,
  } = useDisputeResponse(dispute, onSuccess, () => onOpenChange(false));
